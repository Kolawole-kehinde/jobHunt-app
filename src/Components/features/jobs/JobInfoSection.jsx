...
const JobInfoSection = ({ requirements, benefits }) => (
  <div className="container mx-auto p-6 max-w-4xl">
    <h2 className="text-2xl font-bold mb-6 text-primary border-b-2 border-indigo-300 pb-2">Job Details</h2>
    <div className="rounded-xl bg-white p-8 border border-indigo-100 space-y-6">
      ...
      <Link to="/apply" className="block w-full max-w-md mx-auto px-6 py-3 bg-blue-500 text-white text-lg font-semibold text-center rounded-md shadow-lg hover:bg-blue-600">
        Apply Now
      </Link>
    </div>
  </div>
