export const jobInfoFields = [
  { name: 'title', placeholder: 'Job Title', label: 'Job Title', type: 'text' },
  { name: 'description', placeholder: 'Job Description', label: 'Job Description', type: 'textarea' }, // Updated for textarea
...
export const companyInfoFields = [
  ...
  { name: 'email', placeholder: 'Email Address For Applications', label: 'Email', type: 'email' },
];
